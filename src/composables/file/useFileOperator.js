import { batchDeleteReq, newFolderReq, renameFileReq, renameFolderReq } from '@/api/file-operator'
...
export default function useFileOperator() {
  ...
  const batchDelete = () => {
    ...
    if (
      ...
      notSupportDeleteNotEmptyFolderType.includes(fileDataStore.currentStorageSource.type.key)
    ) {
